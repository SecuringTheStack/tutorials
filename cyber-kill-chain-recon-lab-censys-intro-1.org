...
** Notable Aggregation Features
#+ATTR_REVEAL: :frag (appear)
+ ~Tools~ tab
  1. View On Map
     + [[https://censys.io/ipv4/map?q=/.*hackthissite.*/][Example]]
...
+ In the upcoming slides we'll investigate
  + A few common security vulnerabilities within web apps
  + The HTTP headers that mitigate the vulnerabilities
...
1. Browser Cache
   ...
   2. Google Chrome Ex:
      ...
      4. Search for ~sid~
      5. Q: Is there anything peculiar?
   3. Ex:
