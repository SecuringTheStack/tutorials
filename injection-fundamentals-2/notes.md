...
reveal~center~:nil reveal~control~:nil width:100% height:100% prop:nil

reveal~history~:t reveal~keyboard~:t reveal~overview~:t

reveal~slidenumber~:nil

reveal~titleslide~:"\<h2\>%t\</h2\>\<h3\>%d\<h3\>"

reveal~progress~:t reveal~rollinglinks~:nil reveal~singlefile~:nil
