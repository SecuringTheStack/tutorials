...
+ Primary Datasets
  ...
  3. X.509 Certificates
     ...
     2. Parse certificate fields and annotate with metadata
        1. Ex: [[https://censys.io/certificates?q=%2528tags%253A+%2522self-signed%2522%2529+AND+%2528parsed.extensions.subject_alt_name.dns_names%253A+%252F.*dev.*%252F%2529][~(tags: "self-signed") AND (parsed.extensions.subject_alt_name.dns_names: /.*dev.*/)~]]
           1. Also try ~localhost~
           2. Recon for dev environments
        2. Ex: [[https://censys.io/certificates?q=%2528tags%253A+%2522expired%2522%2529+AND+%2528parsed.extensions.subject_alt_name.dns_names%253A+%252F.*target.*%252F%2529][~(tags: "expired") AND (parsed.extensions.subject_alt_name.dns_names: /.*TARGET.*/)~]]
