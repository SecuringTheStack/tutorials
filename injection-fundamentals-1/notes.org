#+TITLE: Securing Coding Fundamentals
#+DATE: Injection
#+AUTHOR: Zach Roof
...
#+BEGIN_SRC sh
/Applications/Google\ Chrome.app/Contents/MacOS/Google\ Chrome --window-size=720,826 --headless --disable-gpu --screenshot http://localhost:8000/#/sec-title-slide
docker push securingthestack/injection-fundamentals-1
#+END_SRC

* Before Creation :noexport:
+ Stick to one concept per lecture.
  + Just 3-5 points
+ One skill per section
  + 3-5 lectures
+ Sections map to "overarching adjectives" that are placed in the intro
+ Address 80/20 student
...
+ Main Course Title
  + Secure Coding Fundamentals: Injection
* TOC                                                     :TOC_1_gh:noexport:
  :PROPERTIES:
...
+ Concise 80/20 Analysis
  + Who is this course for? Busy Developer
    + Course is designed to be skippable
    + You have 1 hr a week for prof development, do this course
+ Prerequisites: None
...
* Expolit Me
  :PROPERTIES:
  :CUSTOM_ID: h-722A5951-C636-48BD-ACF6-BCCA0CA551EF
  :END:
